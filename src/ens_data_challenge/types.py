...
PATHWAY_GENES = {
    Pathway.SIGNALISATION: {
        'GNB1', 'CSF3R', 'MPL', 'NRAS', 'KRAS', 'FLT3', 'KIT', 'JAK2',
        'PTPN11', 'CBL', 'SH2B3', 'NF1', 'BRAF', 'GNAS', 'STAT3',
        'ETNK1', 'CSNK1A1', 'PPM1D'
    },
    Pathway.EPIGENETIQUE: {
        'TET2', 'DNMT3A', 'IDH1', 'IDH2', 'ASXL1', 'ASXL2', 'EZH2',
        'KDM6A', 'JARID2', 'BCOR', 'BCORL1', 'SUZ12', 'CREBBP'
    },
    Pathway.EPISSAGE: {
        'SF3B1', 'SRSF2', 'U2AF1', 'U2AF2', 'ZRSR2', 'PRPF8'
    },
    Pathway.TRANSCRIPTION: {
        'RUNX1', 'CEBPA', 'GATA2', 'ETV6', 'NFE2', 'IRF1', 'CUX1'
    },
    Pathway.COHESINE: {
        'STAG2', 'SMC1A', 'SMC3', 'RAD21'
    },
    Pathway.TUMOR_SUPPRESSORS: {
        'TP53', 'CHEK2', 'CDKN2A', 'BRCC3', 'PHF6'
    },
    Pathway.AUTRES: {
        'NPM1', 'DDX41', 'TERT', 'NOTCH1', 'MLL', 'ARID2', 'WT1', 'SETBP1', 'OTHER'
    },
}
